 ...
 *
 * <p>This resolves against the root injector, which owns every Kraken singleton (see {@link Context}),
 * so a static utility reached through here and an injected field of the same type are the same object.
 * Prefer constructor or field injection wherever a class can accept it.</p>
 */
...
public final class Services {
    ...
    /**
     * Returns the client-wide {@link Context}, resolving it on first use.
     *
