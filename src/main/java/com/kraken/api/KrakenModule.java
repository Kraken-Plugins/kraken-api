...
import com.kraken.api.service.walker.transport.PlayerStateReader;
...
public class KrakenModule extends AbstractModule {
    ...
    protected void configure() {
        ...
        bind(Walker.class).in(Scopes.SINGLETON);
        bind(ObstacleRecovery.class).in(Scopes.SINGLETON);
        bind(TransportExecutor.class).in(Scopes.SINGLETON);
        bind(PlayerStateReader.class).in(Scopes.SINGLETON);
