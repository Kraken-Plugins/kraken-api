//[lib](../../../index.md)/[com.kraken.api.query.player](../index.md)/[PlayerEntity](index.md)

# PlayerEntity

open class [PlayerEntity](index.md) : [AbstractEntity](../../com.kraken.api.core/-abstract-entity/index.md)&lt;[T](../../com.kraken.api.core/-abstract-entity/index.md)&gt; 

#### Inheritors

| |
|---|
| [LocalPlayerEntity](../-local-player-entity/index.md) |

## Constructors

| | |
|---|---|
| [PlayerEntity](-player-entity.md) | [Kraken API]<br>constructor(ctx: [Context](../../com.kraken.api/-context/index.md), raw: Player) |
...
| [isSkulled](is-skulled.md) | [Kraken API]<br>open fun [isSkulled](is-skulled.md)(): [Boolean](https://kotlinlang.org/api/latest/jvm/stdlib/kotlin-stdlib/kotlin/-boolean/index.html)<br>Returns true if the player has a Skull icon above their head and false otherwise. |
