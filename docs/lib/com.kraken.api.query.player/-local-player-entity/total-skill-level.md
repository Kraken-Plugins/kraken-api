//[lib](../../../index.md)/[com.kraken.api.query.player](../index.md)/[LocalPlayerEntity](index.md)/[totalSkillLevel](total-skill-level.md)

# totalSkillLevel

[Kraken API]\
open fun [totalSkillLevel](total-skill-level.md)(): [Int](https://kotlinlang.org/api/latest/jvm/stdlib/kotlin-stdlib/kotlin/-int/index.html)
