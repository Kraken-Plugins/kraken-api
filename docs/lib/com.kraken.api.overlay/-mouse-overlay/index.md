//[lib](../../../index.md)/[com.kraken.api.overlay](../index.md)/[MouseOverlay](index.md)

# MouseOverlay

[Kraken API]\
open class [MouseOverlay](index.md)

## Constructors

| | |
|---|---|
| [MouseOverlay](-mouse-overlay.md) | [Kraken API]<br>constructor(client: Client) |
