//[lib](../../../index.md)/[com.kraken.api.core.packet.entity](../index.md)/[WidgetPackets](index.md)/[queueDragAndDrop](queue-drag-and-drop.md)

# queueDragAndDrop

[Kraken API]\
open fun [queueDragAndDrop](queue-drag-and-drop.md)(src: Widget, dest: Widget)
