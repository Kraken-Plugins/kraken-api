//[kraken-api](../../../index.md)/[com.kraken.api.core.packet](../index.md)/[ObfuscatedNames](index.md)/[classContainingGetPacketBufferNodeName](class-containing-get-packet-buffer-node-name.md)
