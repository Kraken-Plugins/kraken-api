//[kraken-api](../../../index.md)/[com.kraken.api.core](../index.md)/[AbstractQuery](index.md)
...
| [distinctById](distinct-by-id.md) | [Kraken API]<br>open fun [distinctById](distinct-by-id.md)(): [Q](index.md)<br>Filters the stream of elements, ensuring only unique elements are returned based on their IDs. |
...
| [unique](unique.md) | [Kraken API]<br>open fun [unique](unique.md)(): [Q](index.md)<br>Ensures that only unique elements based on their IDs are included in the stream. |
