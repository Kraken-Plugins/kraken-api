//[kraken-api](../../../index.md)/[com.kraken.api.query.world](../index.md)/[WorldEntity](index.md)

# WorldEntity

[Kraken API]\
open class [WorldEntity](index.md) : [AbstractEntity](../../com.kraken.api.core/-abstract-entity/index.md)&lt;[T](../../com.kraken.api.core/-abstract-entity/index.md)&gt;

## Constructors

| | |
|---|---|
| [WorldEntity](-world-entity.md) | [Kraken API]<br>constructor(ctx: [Context](../../com.kraken.api/-context/index.md), raw: World, httpPackageWorld: World) |
...
| [hop](hop.md) | [Kraken API]<br>open fun [hop](hop.md)(): [Boolean](https://kotlinlang.org/api/latest/jvm/stdlib/kotlin-stdlib/kotlin/-boolean/index.html)<br>Attempts to perform a world hop for the current `WorldEntity`. |
...
| [isMember](is-member.md) | [Kraken API]<br>open fun [isMember](is-member.md)(): [Boolean](https://kotlinlang.org/api/latest/jvm/stdlib/kotlin-stdlib/kotlin/-boolean/index.html)<br>Returns true if the account is a member and false otherwise |
...
| [membershipDaysRemaining](membership-days-remaining.md) | [Kraken API]<br>open fun [membershipDaysRemaining](membership-days-remaining.md)(): [Int](https://kotlinlang.org/api/latest/jvm/stdlib/kotlin-stdlib/kotlin/-int/index.html)<br>Returns the number of days of membership the account has left. |
