...
| [depositAll](deposit-all.md) | [Kraken API]<br>open fun [depositAll](deposit-all.md)(): [Boolean](https://kotlinlang.org/api/latest/jvm/stdlib/kotlin-stdlib/kotlin/-boolean/index.html)<br>Deposit all items in the player's inventory into the bank. |
