//[kraken-api](../../../index.md)/[com.kraken.api.input.mouse.strategy.replay](../index.md)/[ReplayStrategy](index.md)/[loadLibrary](load-library.md)

# loadLibrary

[Kraken API]\
open fun [loadLibrary](load-library.md)(library: [String](https://docs.oracle.com/en/java/javase/11/docs/api/java.base/java/lang/String.html))
